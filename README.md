...
```
cd existing_repo
git remote add origin https://gitlab.com/Cecilegltslmcs/ingestion_hadoop_mapreduce.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Cecilegltslmcs/ingestion_hadoop_mapreduce/-/settings/integrations)
